...
import telegram.bot.api.exception.updatingexception.EditMessageCaptionException;
import telegram.bot.api.exception.updatingexception.EditMessageReplyMarkupException;
import telegram.bot.api.exception.updatingexception.EditMessageTextException;
import telegram.bot.api.interfaces.BotInterface;
import telegram.bot.api.json.JSONObject;
import telegram.bot.api.net.MultipartFormData;
import telegram.bot.api.net.SSLConnection;
...
public class Bot implements BotInterface {
     ...
     *
     * @return {@link telegram.bot.api.entity.User User} - Basic information about the bot
     *
     * @throws IOException
     */
